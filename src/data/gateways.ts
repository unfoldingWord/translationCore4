...
export const GATEWAYS: Gateway[] = [
  { id: 'en', org: 'unfoldingWord', name: 'English', autonym: 'English', dir: 'ltr', seen: { tn: 'v89', tw: 'v89', ta: 'v89' }, hasTwl: true, hasBible: true },
  { id: 'es-419', org: 'es-419_gl', name: 'Spanish (Latin American)', autonym: 'Español (Latinoamérica)', dir: 'ltr', seen: { tn: 'v66', tw: 'v37', ta: 'v4' }, hasTwl: true, hasBible: true },
  { id: 'fr', org: 'Xenizo', name: 'French', autonym: 'Français', dir: 'ltr', seen: { tn: 'v2.0', tw: 'v2.0', ta: 'v2.0' }, hasTwl: true, hasBible: false },
  { id: 'fr', org: 'MVHS', name: 'French', autonym: 'Français', dir: 'ltr', seen: { tn: 'v0.0.2', tw: 'v0.0.1', ta: 'v0.0.2' }, hasTwl: true, hasBible: true },
  { id: 'ru', org: 'ru_gl', name: 'Russian', autonym: 'Русский', dir: 'ltr', seen: { tn: 'v60.1', tw: 'v14.2', ta: 'v13.3' }, hasTwl: true, hasBible: true },
  { id: 'fa', org: 'fa_gl', name: 'Persian', autonym: 'فارسی', dir: 'rtl', seen: { tn: 'v9', tw: 'v9', ta: 'v7.8' }, hasTwl: true, hasBible: true },
  { id: 'ar', org: 'BSOJ', name: 'Arabic', autonym: 'العربية', dir: 'rtl', seen: { tn: 'v6.1', tw: 'v5', ta: 'v3' }, hasTwl: true, hasBible: true },
  { id: 'ar', org: 'ar_gt', name: 'Arabic', autonym: 'العربية', dir: 'rtl', seen: { tn: 'v3.2', tw: 'v3', ta: 'v3.3' }, hasTwl: false, hasBible: true },
  { id: 'id', org: 'bahtraku', name: 'Indonesian', autonym: 'Bahasa Indonesia', dir: 'ltr', seen: { tn: 'v25', tw: 'v26', ta: 'v30' }, hasTwl: true, hasBible: true },
  { id: 'hi', org: 'translationCore-Create-BCS', name: 'Hindi', autonym: 'हिन्दी', dir: 'ltr', seen: { tn: 'v9', tw: 'v8', ta: 'v7' }, hasTwl: true, hasBible: true },
  { id: 'bn', org: 'translationCore-Create-BCS', name: 'Bengali', autonym: 'বাংলা', dir: 'ltr', seen: { tn: 'v6', tw: 'v4', ta: 'v5.0' }, hasTwl: true, hasBible: true },
  { id: 'gu', org: 'translationCore-Create-BCS', name: 'Gujarati', autonym: 'ગુજરાતી', dir: 'ltr', seen: { tn: 'v6', tw: 'v4', ta: 'v4' }, hasTwl: true, hasBible: true },
  { id: 'kn', org: 'translationCore-Create-BCS', name: 'Kannada', autonym: 'ಕನ್ನಡ', dir: 'ltr', seen: { tn: 'v6', tw: 'v4', ta: 'v4' }, hasTwl: true, hasBible: true },
  { id: 'mr', org: 'translationCore-Create-BCS', name: 'Marathi', autonym: 'मराठी', dir: 'ltr', seen: { tn: 'v6', tw: 'v4', ta: 'v4' }, hasTwl: true, hasBible: true },
  { id: 'ne', org: 'translationCore-Create-BCS', name: 'Nepali', autonym: 'नेपाली', dir: 'ltr', seen: { tn: 'v7', tw: 'v5', ta: 'v5' }, hasTwl: true, hasBible: true },
  { id: 'or', org: 'translationCore-Create-BCS', name: 'Odia', autonym: 'ଓଡ଼ିଆ', dir: 'ltr', seen: { tn: 'v5', tw: 'v4', ta: 'v4' }, hasTwl: true, hasBible: true },
  { id: 'te', org: 'translationCore-Create-BCS', name: 'Telugu', autonym: 'తెలుగు', dir: 'ltr', seen: { tn: 'v6', tw: 'v4', ta: 'v4' }, hasTwl: true, hasBible: true },
  { id: 'ml', org: 'Door43-Catalog', name: 'Malayalam', autonym: 'മലയാളം', dir: 'ltr', seen: { tn: 'v14.2', tw: 'v8.2', ta: 'v10.3' }, hasTwl: false, hasBible: true },
  { id: 'ur-deva', org: 'Door43-Catalog', name: 'Urdu (Devanagari)', autonym: 'اردو', dir: 'rtl', seen: { tn: 'v14.1', tw: 'v8.3', ta: 'v10.1' }, hasTwl: false, hasBible: true },
];
