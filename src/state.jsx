...
async function loadObsStory({ api, resolveContext, store, repoPath, number, resources, scheduler, seq, storeRef, stateRef, dispatch, rememberObsStory }) {
  try {
    ...
    dispatch({ type: 'set', patch: { storyNumber: number, story: presentation.story, sourceStory: presentation.sourceStory, storyImages: presentation.images, storySourceError: presentation.sourceError, storySourceMissing: presentation.sourceMissing, storyLoading: false, storyError: null } });
...
async function openObsStory({ storyNumber, resourcesOverride, context, stateRef, storeRef, saveRefs, dispatch, api, resolveContext, scheduler, rememberObsStory }) {
  ...
  dispatch({ type: 'set', patch: { storyNumber: target.number, story: null, sourceStory: null, storyImages: {}, storyLoading: true, storyError: null, storySourceError: null, storySourceMissing: false } });
  await loadObsStory({
    api,
    resolveContext,
    store: target.store,
