...
export function Drawer({ open = true, eyebrow, title, width = 440, onClose, children }) {
  if (!open) return null;
  return (
    <div onClick={onClose} style={{ position: 'fixed', inset: 0, background: 'var(--scrim-drawer)', zIndex: 50, display: 'flex', justifyContent: 'flex-end' }}>
