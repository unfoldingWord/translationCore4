...
does not already give. [VERIFIED — `docs/evidence/rig-job-ci-2026-09-04.md`: run 33926954276 on
ubuntu-24.04, 2026-09-04, both controls green, 3 min 2 s with a warm cargo cache]
