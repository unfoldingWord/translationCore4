...
The **journal conformance suite** (§8.9; 59 checks, J1–J20 per Appendix A) validates the full §8 semantics, the publication topology, and the intake rejection rules separately: `npm run validate:journal`. Both suites: `npm run validate:all`.
